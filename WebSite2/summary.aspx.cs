...
public partial class summary : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        comm.CommandText = "select * from credit where sys_date >= '" + sdate + "' and sys_date <='" + edate + "';";
        else
            comm.CommandText = "select * from credit where cheque_date >= '" + sdate + "' and cheque_date <='" + edate + "';";
        conn.Open();
